...
export HARBOR_USER=itsacrtanzurep
export HARBOR_PWD=""
export HARBOR_DOMAIN="itsacrtanzurep.azurecr.io"
export tbs=1.9.6
export INSTALL_REGISTRY_HOSTNAME=""
export INSTALL_REGISTRY_USERNAME=itsacrtanzurep 
export INSTALL_REGISTRY_PASSWORD=""
export BUNDLE="itsacrtanzurep.azurecr.io/tap/cluster-essentials-bundle:sha256-a119cb90111379a5f91d27ae572a0de860dd7322179ab856fb32c45be95d78f5.imgpkg"
...
tanzu package repository add tanzu-tap-repository --url $HARBOR_DOMAIN/tap/tap-packages:$tap_version --namespace tap-install
